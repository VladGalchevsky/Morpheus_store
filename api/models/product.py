...
class UpdateProduct(TunedModel):
    name: str | None = Field(
        default=None, min_length=1, description="Optional updated name for the product"
    )
    description: str | None = Field(
        default=None, min_length=1, description="Optional updated description"
    )
    price: float | None = Field(
        default=None, gt=0, description="Optional updated price, must be greater than 0"
    )
